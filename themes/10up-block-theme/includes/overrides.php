...
namespace TenupBlockTheme\Overrides;
...
function setup() {
	...
	add_filter( 'tiny_mce_plugins', 'TenupBlockTheme\Overrides\disable_emojis_tinymce' );
	add_filter( 'wp_resource_hints', 'TenupBlockTheme\Overrides\disable_emoji_dns_prefetch', 10, 2 );
